...
from image_generator.serializers.generate_images import GeneratedImageListSerializer, GeneratedImageCreateSerializer
...
class GeneratedImageViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response({'message': SUCCESS_MESSAGES['images']['generated']}, status=status.HTTP_201_CREATED)
